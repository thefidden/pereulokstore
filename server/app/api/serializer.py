...
from .models import (
    Product, ProductImage, AuthenticationRequest, Cart, Order, OrderProduct, AuthenticationToken, UserImage, Tag, ProductTag
)
...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ['id', 'type', 'name', 'price', 'description', 'images', 'uploaded_images', 'link', 'product_tags']
